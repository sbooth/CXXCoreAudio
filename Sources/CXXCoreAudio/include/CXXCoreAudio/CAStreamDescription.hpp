...
cxx_cf::CFString
CopyAudioStreamBasicDescriptionFormatName(const AudioStreamBasicDescription& streamDescription) noexcept;
...
struct CAStreamDescription final : public AudioStreamBasicDescription {
    ...
    [[nodiscard]] cxx_cf::CFString CopyFormatName() const noexcept;

    /// Returns a string representation of this format.
    [[nodiscard]] cxx_cf::CFString CopyFormatDescription() const noexcept;
...
inline cxx_cf::CFString CAStreamDescription::CopyFormatName() const noexcept {
    return CopyAudioStreamBasicDescriptionFormatName(*this);
}

inline cxx_cf::CFString CAStreamDescription::CopyFormatDescription() const noexcept {
